...
public class Alta1 extends WindowAdapter implements ActionListener
{
	Frame ventana = new Frame("AltaCiclo");
	...
	public void actionPerformed(ActionEvent evento)
	{
		if(evento.getSource().equals(btnAceptar))
		{
			try
			{
				...
				sentenciaSQL = "INSERT INTO ciclos VALUES(null, '"+txtNom.getText()+"','"+txtDescripcion.getText()+"')";
